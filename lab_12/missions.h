...
void mission_2() {
	...
	cin >> command;
	if (command[0] == 'с' || command[0] == 'C') {
		if (command[1] == '-' && command[2] == '1')
			cout << "   Шёл на СЕВЕР, повернул НАПРАВО, иду на ВОСТОК! \n";
		if (command[1] == '1')
			cout << "   Шёл на СЕВЕР, повернул НАЛЕВО, иду на ЗАПАД! \n";
		if (command[1] == '0')
			cout << "   Как шёл на СЕВЕР, так и иду! \n";
	}
	if (command[0] == 'в' || command[0] == 'В') {
		if (command[1] == '-' && command[2] == '1')
			cout << "   Шёл на ВОСТОК, повернул НАПРАВО, иду на ЮГ! \n";
		if (command[1] == '1')
			cout << "   Шёл на ВОСТОК, повернул НАЛЕВО, иду на СЕВЕР! \n";
		if (command[1] == '0')
			cout << "   Как шёл на ВОСТОК, так и иду! \n";
	}
	if (command[0] == 'ю' || command[0] == 'Ю') {
		if (command[1] == '-' && command[2] == '1')
			cout << "   Шёл на ЮГ, повернул НАПРАВО, иду на ЗАПАД! \n";
		if (command[1] == '1')
			cout << "   Шёл на ЮГ, повернул НАЛЕВО, иду на ВОСТОК! \n";
		if (command[1] == '0')
			cout << "   Как шёл на ЮГ, так и иду! \n";
	}
	if (command[0] == 'з' || command[0] == 'З') {
		if (command[1] == '-' && command[2] == '1')
			cout << "   Шёл на ЗАПАД, повернул НАПРАВО, иду на СЕВЕР! \n";
		if (command[1] == '1')
			cout << "   Шёл на ЗАПАД, повернул НАЛЕВО, иду на ЮГ! \n";
		if (command[1] == '0')
			cout << "   Как шёл на ЗАПАД, так и иду! \n";
	}
